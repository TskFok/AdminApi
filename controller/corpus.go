...
func CorpusList(ctx *gin.Context) {
...
func AddCorpus(ctx *gin.Context) {
	...
	cache.Set("embeding:"+i, string(bd), -1)

}

func UpdateCorpus(ctx *gin.Context) {
	...
	cache.Set("embeding:"+id, string(bd), -1)
}

func DelCorpus(ctx *gin.Context) {
	id := ctx.Param("id")
	logger.Error(id)
